...
export const metadata: Metadata = {
  title: "Blog Details Page | ScaleUP Event and Exhibition",
  description: "This is Blog Details Page for ScaleUP Event and Exhibition",
  // other metadata
}; */
...
const BlogDetailsPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("http://localhost:3000/api/blog_details/2");
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  ...
                  {/*heading */}
                  {/* {firstBlogPost && firstBlogPost.heading} */}
                  {BlogDetails.heading}
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                         {/*author name */}
                          By <span>{BlogDetails.author}</span>
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        {/* loop through all popular_tags stored array */ }
                        {BlogDetails.popular_tags.map((tag, index) => (
